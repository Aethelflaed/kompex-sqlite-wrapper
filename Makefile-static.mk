...
# CC Compiler Flags
CPPFLAGS= -O2 -I${includedir} -MMD -MP

# Link Libraries and Options
LDLIBSOPTIONS=

# Build Targets
.build-conf: .pre-build ${prelibdir}/${PRODUCT_NAME}.a

.pre-build:
	$(MKDIR) -p ${prelibdir}
	$(MKDIR) -p ${objsdir}
	$(RM) ${objsdir}/*.d
	$(RM) ${prelibdir}/${PRODUCT_NAME}.a

${prelibdir}/${PRODUCT_NAME}.a: ${OBJS}
	${AR} rv ${prelibdir}/${PRODUCT_NAME}.a ${OBJS} 
	$(RANLIB) ${prelibdir}/${PRODUCT_NAME}.a
